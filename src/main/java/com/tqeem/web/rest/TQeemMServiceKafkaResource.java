...
@RestController
@RequestMapping("/api/t-qeem-m-service-kafka")
public class TQeemMServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TQeemMServiceKafkaResource.class);
    ...
    public TQeemMServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
